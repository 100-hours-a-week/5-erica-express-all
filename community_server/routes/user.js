...
//비밀번호 변경
router.patch('/user/password', modifyAuthUser, userController.updateUserpassword)
...
//닉네임 중복 체크
router.post('/nickname/:nickname', getAuthUser, userController.duplicateNickname)

//회원가입시 중복 체크
router.post('/signup/nickname/:nickname', userController.duplicateSignUpNickname)
